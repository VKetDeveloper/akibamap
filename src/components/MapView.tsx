...
const spots: Spot[] = [
  ...
  { id: 16, name: 'GiGO秋葉原1号館', type: 'ゲームセンター', lat: 35.69869, lng: 139.771065, description: 'STGとレトロアケゲーの聖地。移植が絶望的な激レアゲームも。', imageUrl: 'images/notimg.png', siteurl: 'https://tempo.gendagigo.jp/am/akiba-1/', nfsw: false },
  { id: 17, name: 'GiGO秋葉原2号館', type: 'ゲームセンター', lat: 35.697769 , lng: 139.771458, description: 'STGとレトロアケゲーの聖地。移植が絶望的な激レアゲームも。', imageUrl: 'images/notimg.png', siteurl: 'https://tempo.gendagigo.jp/am/akiba-2/', nfsw: false },
